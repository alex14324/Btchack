#Tron Wallet Generator Check API for balance mizogg.co.uk 25/07/21
import ecdsa
import base58
import random
import requests
...
print(colour_cyan + "tronbal.py---" + colour_red + "Random Scan for TRON TRX Addresses Balances/Total Received Ammount----mizogg.co.uk"  + colour_reset + seconds_to_str())
...
def seek():
    ...
    while True:
        ...
        print(colour_cyan + "trponbal.py---" + colour_red + "Random Scan for TRON TRX Addresses Balances/Total Received Ammount" + colour_reset) 
