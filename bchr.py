#Mizogg 06/07/2021 mizogg.co.uk Random Scan for bitcoin cash Addresses and Balance Random Made by mizogg.co.uk
...
while True:
    ...
    print (colour_green +  ' <================================= Bitcoin CASH Addresses Checked for Balance =================================>' + '\n' +  colour_reset)
    ...
    print(colour_cyan + "---bchr2.py---" + colour_red + "Random Scan for Bitcoin CASH Addresses and Check Balance---------mizogg.co.uk" + colour_cyan + "---bchr2.py--- "  + colour_reset + seconds_to_str())
